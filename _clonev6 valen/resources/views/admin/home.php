    ...
    <div class="content">
        <div class="container-fluid">
            <div class="alert alert-info">
                ...
                <h5>Gửi quý khách hàng của <b>VALEN</b></h5>
                <ul>
                    <li>Quý khách vui lòng tham gia nhóm Zalo của VALEN để nắm bắt thông tin cập nhật chi tiết của sản
                    ...
                    <li>Quý khách tham gia nhóm nhận thông tin thông báo tại đây: <a target="_blank"
                            href="https://zalo.me/g/lqwuqh418">https://zalo.me/g/lqwuqh418</a></li>
                    <li>Inbox ngay cho VALEN để được duyệt tham gia nhóm, chỉ áp dụng cho quý khách hàng mua chính chủ
                        tại <a target="_blank" href="https://ngthaivinh.io.vn/">ĐÂY</a></li>
            ...
            <div class="alert alert-dark">
                ...
                <ul>
                    <li>Chi tiết cập nhật vui lòng xem tại <a target="_blank" href="https://zalo.me/g/lqwuqh418">đây</a>
                        (chỉ áp dụng cho khách hàng mua chính hãng tại VALEN)</li>
                </ul>
